        ...
        if (!mCompletionOn) {
            if (mComposing.length() > 0) {
                if (mComposing.toString().toLowerCase().contentEquals("b")){
                    setSuggestions(new ArrayList<String>(Arrays.asList(mComposing.toString().toLowerCase().replace("xm", "布"))), true, true);}
                else if (mComposing.toString().toLowerCase().contentEquals("c")){
                    setSuggestions(new ArrayList<String>(Arrays.asList(mComposing.toString().toLowerCase().replace("cruz", "克"))), true, true);}
            }
        } else {
            setSuggestions(null, false, false);
        ...
        if (!mCompletionOn) {
            if (mComposing.length() > 0) {
                if (mComposing.toString().toLowerCase().contentEquals("ad")){
                    ...
                    setSuggestions(new ArrayList<String>(Arrays.asList(mComposing.toString().toLowerCase().replace("Junt", "哈"))), true, true);}
                    ...
                    setSuggestions(new ArrayList<String>(Arrays.asList(mComposing.toString().toLowerCase().replace("lind", "美"), "美", "碧", "比")), true, true);}
            } else {
                    setSuggestions(null, false, false);
                }
            }
